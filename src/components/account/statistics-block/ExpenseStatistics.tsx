...
const ExpenseStatistics = ({
    ...
    if (i === 12) {
      return (
        <MonthStatistic
          ...
          month={month}
          expense={expenses[i]}
          predictHeight={currentPredictHeight}
          predictExpense={currentPredict}
        />
      );
    } else if (i === 13) {
      return (
        <MonthStatistic
          ...
          month={month}
          expense={expenses[i]}
          predictHeight={nextPredictHeight - 0.5}
          predictExpense={nextPredict}
        />
      );
    } else {
      return (
  ...
  return (
    <div className='w-full'>
      <div className='flex justify-between items-end gap-1 xs:gap-2 sm:gap-3 px-1'>{graph}</div>
